          ...
          child: ClipRRect(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if(!task.check && task.dateIsSet && DateTime.now().compareTo(task.deadline) == 1){
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                        '${task.descriptionOfTask ?? ''} ${task.dateIsSet ? 'Сделать до $deadlineDate${task.timeIsSet ? ' $deadlineTime' : ''}' : '' }'),
                    trailing: Checkbox(
                      value: task.check,
